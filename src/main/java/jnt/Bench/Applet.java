...
/**
 * jnt.Bench.Applet provides an Applet or Application with GUI to display and
 * execute a benchmark implementing jnt.Bench.Target.
 *
...
public class Applet extends java.applet.Applet {
    ...
    public void stop() {
        abortBenchmark();
    }		// kill the benchmarking process, if any.
